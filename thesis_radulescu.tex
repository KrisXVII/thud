...
Nella versione successiva del prodotto in cui sono state migliorate le performance sia in fatto di tempo che di memoria e utilizzo delle risorse è stata aggiunta una nuova sezione su
richiesta del cliente: il monitoring custom. Questi aveva richiesto la possibilità di creare un Monitoring che uscisse dagli schemi dei tre piani disponibili quindi cambiando i parametri che sono
fissi per come sono stati implementati. Ad esempio un abbonamento standard comprende tre metodi di ricerca, mentre quello successivo ne comprende dieci, ma il cliente vorrebbe un monitoring con
sette metodologie mirate a ciò di cui necessita e questo non si limita ai parametri di ricerca. È stato aggiunto nella pagina della lista delle scansioni effettuate un bottone che solo un
backoffice vedrà nell'interfaccia e che apre una modale contenente un form in cui vengono inseriti i parametri personalizzati richiesti.
